...
def training_compiler(gm, example_inputs):
    ...
    return aot_module_simplified(gm, example_inputs, fw_compiler=fw_compiler, bw_compiler=bw_compiler)
...
class TorchXLAReuseGraphTest(unittest.TestCase):
    ...
    test_training_maxpool = unittest.skip("max_pool2d does not work: https://github.com/pytorch/torchdynamo/issues/1837")(make_training_test(MaxPoolModule))
